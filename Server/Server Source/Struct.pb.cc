...
PROTOBUF_CONSTEXPR ChatSenderInfo::ChatSenderInfo(
    ::_pbi::ConstantInitialized): _impl_{
...
struct ChatSenderInfoDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ChatSenderInfoDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ChatSenderInfoDefaultTypeInternal() {}
  union {
    ChatSenderInfo _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChatSenderInfoDefaultTypeInternal _ChatSenderInfo_default_instance_;
}  // namespace Protocol
...
const uint32_t TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::PlayerInfo, _impl_.room_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::ChatSenderInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::ChatSenderInfo, _impl_.player_id_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ChatSenderInfo, _impl_.room_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ChatSenderInfo, _impl_.sendername_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Protocol::PlayerInfo)},
  { 13, -1, -1, sizeof(::Protocol::ChatSenderInfo)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::Protocol::_PlayerInfo_default_instance_._instance,
  &::Protocol::_ChatSenderInfo_default_instance_._instance,
};
...
const char descriptor_table_protodef_Struct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "state\030\006 \001(\0162\025.Protocol.PlayerState\022 \n\004ro"
  "om\030\007 \001(\0162\022.Protocol.RoomType\"Y\n\016ChatSend"
  "erInfo\022\021\n\tPlayer_ID\030\001 \001(\004\022 \n\004room\030\002 \001(\0162"
  "\022.Protocol.RoomType\022\022\n\nSenderName\030\003 \001(\tb"
  "\006proto3"
  ;
...
PlayerInfo::PlayerInfo(const PlayerInfo& from)
  ...
  ::memcpy(&_impl_.player_id_, &from._impl_.player_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.room_) -
    reinterpret_cast<char*>(&_impl_.player_id_)) + sizeof(_impl_.room_));
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_room(static_cast<::Protocol::RoomType>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.PlayerInfo)
  ...
  if (this->_internal_room() != 0) {
    total_size += 1 +
      ::_pbi::WireFormatLite::EnumSize(this->_internal_room());
  }
...
void PlayerInfo::InternalSwap(PlayerInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PlayerInfo, _impl_.room_)
      + sizeof(PlayerInfo::_impl_.room_)
...
class ChatSenderInfo::_Internal {
 public:
};

ChatSenderInfo::ChatSenderInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.ChatSenderInfo)
}
ChatSenderInfo::ChatSenderInfo(const ChatSenderInfo& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ChatSenderInfo* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  ::memcpy(&_impl_.player_id_, &from._impl_.player_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.room_) -
    reinterpret_cast<char*>(&_impl_.player_id_)) + sizeof(_impl_.room_));
  // @@protoc_insertion_point(copy_constructor:Protocol.ChatSenderInfo)
}

inline void ChatSenderInfo::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
ChatSenderInfo::~ChatSenderInfo() {
  // @@protoc_insertion_point(destructor:Protocol.ChatSenderInfo)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void ChatSenderInfo::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.sendername_.Destroy();
}

void ChatSenderInfo::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void ChatSenderInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.ChatSenderInfo)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ChatSenderInfo::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Protocol.ChatSenderInfo.SenderName"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* ChatSenderInfo::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.ChatSenderInfo)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_sendername().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "Protocol.ChatSenderInfo.SenderName");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.ChatSenderInfo)
  return target;
}

size_t ChatSenderInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.ChatSenderInfo)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ChatSenderInfo::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    ChatSenderInfo::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ChatSenderInfo::GetClassData() const { return &_class_data_; }


void ChatSenderInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ChatSenderInfo*>(&to_msg);
  auto& from = static_cast<const ChatSenderInfo&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.ChatSenderInfo)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void ChatSenderInfo::CopyFrom(const ChatSenderInfo& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.ChatSenderInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ChatSenderInfo::IsInitialized() const {
  return true;
}

void ChatSenderInfo::InternalSwap(ChatSenderInfo* other) {
  using std::swap;
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ChatSenderInfo, _impl_.room_)
      + sizeof(ChatSenderInfo::_impl_.room_)
      - PROTOBUF_FIELD_OFFSET(ChatSenderInfo, _impl_.player_id_)>(
          reinterpret_cast<char*>(&_impl_.player_id_),
          reinterpret_cast<char*>(&other->_impl_.player_id_));
}

::PROTOBUF_NAMESPACE_ID::Metadata ChatSenderInfo::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Struct_2eproto_getter, &descriptor_table_Struct_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::Protocol::ChatSenderInfo*
Arena::CreateMaybeMessage< ::Protocol::ChatSenderInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::ChatSenderInfo >(arena);
}
