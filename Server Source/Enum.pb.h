...
enum PlayerState : int {
  ...
  PLAYER_STATE_RUN = 2,
  PLAYER_STATE_JUMP = 3,
  PLAYER_STATE_ATTACK = 4,
  PLAYER_STATE_HITTED = 5,
  PLAYER_STATE_STUN = 6,
  PLAYER_STATE_DIE = 7,
  PLAYER_STATE_DASH = 8,
...
constexpr PlayerState PlayerState_MAX = PLAYER_STATE_DASH;
...
constexpr RoomType RoomType_MIN = ROOM_TUTORIAL;
constexpr RoomType RoomType_MAX = ROOM_FIRSTDUN;
