...
// Sets default values
AUnitBase::AUnitBase() : 
	m_FStat{}, m_eUnitState{}, m_mapBuff{}
{
...
void AUnitBase::BeginPlay()
{
	...
	if (m_eCharType == ECharType::E_Hero)
	{
		m_PlayerInfo = new Protocol::PlayerInfo();
		m_DestInfo = new Protocol::PlayerInfo();
	}
}
...
// ==================================== 서버 동기화 관련 =======================================
void AUnitBase::SetPlayerInfo(const Protocol::PlayerInfo& Info)
{
	// 처음 Room입장할때나 호출됨. ID 세팅 & 첫위치 세팅 & 방정보 세팅
	m_PlayerInfo->CopyFrom(Info);
	FVector NewLocation(Info.x(), Info.y(), Info.z());
	SetActorLocation(NewLocation);
}

void AUnitBase::SetMoveState(Protocol::PlayerState StateInfo)
{
}

void AUnitBase::SetDestInfo(const Protocol::PlayerInfo& Info, int32 DashIdx)
{
}
